...
export const CURRENCY_REGIONS = [
  {
    region: "Popular",
    codes: ["USD", "EUR", "GBP", "JPY", "KRW", "AUD", "CAD", "CHF", "CNY"],
  },
  {
    region: "Europe",
    codes: [
  ...
  { region: "South Asia", codes: ["INR", "PKR", "BDT", "LKR", "NPR"] },
  {
    ...
    codes: ["SGD", "THB", "MYR", "IDR", "PHP", "VND"],
  },
  {
    region: "Middle East",
    codes: ["TRY", "ILS", "AED", "SAR", "QAR", "KWD", "BHD", "OMR", "JOD"],
  },
  {
    region: "Africa",
    codes: ["ZAR", "NGN", "KES", "EGP", "MAD", "GHS", "TZS", "UGX", "ETB"],
  },
