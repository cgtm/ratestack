export default {
  ...
  "rates.updatedRelative": "Tipos de cambio actualizados {{relative}}",
  "rates.pending": "Esperando tipos de cambio…",
  "rates.disclaimer":
    "Tipos indicativos solo informativos; no constituyen asesoramiento financiero.",
  "rates.offline":
    "Sin conexión. Pueden mostrarse los últimos tipos guardados.",
  ...
  "theme.forest": "Bosque oscuro",
  "theme.forest-light": "Bosque claro",
  "theme.ember": "Brasa oscuro",
  "theme.auto": "Automático (Sistema)",
  "theme.ember-light": "Brasa claro",
  ...
  "rates.error":
    "No se pudieron actualizar las tasas. Mostrando los últimos valores conocidos.",
